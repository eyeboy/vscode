...
import { AgentHostClaudeAgentEnabledSettingId, AgentHostCodexAgentBinaryArgsSettingId, AgentHostCodexAgentEnabledSettingId, AgentHostCodexAgentSdkRootSettingId, AgentHostCodexAgentCodexHomeSettingId, AgentHostOTelCaptureContentSettingId, AgentHostOTelDbSpanExporterEnabledSettingId, AgentHostOTelEnabledSettingId, AgentHostOTelExporterTypeSettingId, AgentHostOTelOtlpEndpointSettingId, AgentHostOTelOutfileSettingId, ClaudeLocalAgentEnabledSettingId, buildAgentHostOTelEnv, buildAgentSdkEnv } from '../common/agentService.js';
...
export class ElectronAgentHostStarter extends Disposable implements IAgentHostStarter {
	...
	async start(): Promise<IAgentHostConnection> {
		...
		const sdkEnv = buildAgentSdkEnv({
			...
			claudeLocalAgentEnabled: this._configurationService.getValue<boolean>(ClaudeLocalAgentEnabledSettingId),
		}, process.env);
