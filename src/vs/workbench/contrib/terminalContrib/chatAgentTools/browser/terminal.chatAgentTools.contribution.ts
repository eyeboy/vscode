...
import { ClaudeLocalAgentForwarder } from './claudeLocalAgentForwarder.js';
...
registerWorkbenchContribution2(ClaudeLocalAgentForwarder.ID, ClaudeLocalAgentForwarder, WorkbenchPhase.AfterRestored);
